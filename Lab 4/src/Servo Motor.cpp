...
const int minPulseWidth = 500; // 0.5 ms (changed to 1500)
const int maxPulseWidth = 2500; // 2.5 ms (changed to 4000)
...
void setup() {
  ...
  myServo.setPeriodHertz(50); // Standard 50Hz servo; changed to 10
}

void loop() {
  // Rotate the servo from 0 to 180 degrees (change to 90)
